<div>
  <span>
    <h1> 👐 Hi there</h1>
    <h2>My profile page has been renovated!</h2>
  </span>
...
- My repos may contain content that makes you uncomfortable.
- If you still feel okay, keep scrolling.

---

## Feed me

Crypto only for now; I can't think of anything else suitable besides crypto.
...
## <sub>Hi everyone, I'm a **loli**<sub>~~_con_~~</sub>, come check out my ~~_masturbation_~~ toys!</sub>
...
[![Homepage (New site!)](<https://img.shields.io/badge/Homepage%20(New%20site!)-sbchild.top-information?style=flat-square>)](https://sbchild.top/)

[Generate your Duolingo sticker](https://github.com/sb-child/OhMyDuo)

## 🔰 Written ~~in the front~~ in the middle

- :rainbow_flag: [**Click the link to support LGBTQIA+ equality!**](https://github.com/LGBT-CN/LGBTQIA-in-China/)
- :transgender_flag: transgender girl | pronouns: \[She/Her\] / \[They/Them\] / ~~whatever else you want (never mind this)~~
- nickname: `色妹妹` or `纱月酱` (someone else gave me this one) | ~~sorry that I haven't an English name~~ just call me `sbchild`
- Telegram: https://t.me/sbchild
- Discord: [@sb_child](https://discord.gg/yFnvtD3W)
- Come chat with me on NanChat: ID `sbchild` | Address `nano_1hw954zuqwbogs4w6hrj585p75jey5yycm3kosau85586kk9gpxneegwb1e7`

## 🤔 Planning board (I almost forgot this thing exists)
...
Next you should go check out <https://github.com/sb-child/ecosystem>, but here are some briefs:

### Cryptography / security related
...
Brand-new, zero-dependency, zero-error, zero-warning libraries, once owned by a cute girl, ¥9.9 with free shipping — [grab them now](https://github.com/sb-child/ecosystem#%E8%87%AA%E7%94%A8%E7%B1%BB%E5%BA%93)!

### Minecraft related

Even though I haven't played it for a long time, there are [some relics](https://github.com/sb-child/ecosystem#minecraft-%E7%9B%B8%E5%85%B3) here.
...
I got bored at school and built a keyboard, but didn't finish the firmware (yes, I want to write it myself)...

If you're interested, you can [take a look](https://github.com/sb-child/ecosystem/blob/main/keyboard.md).

### Memes

But not meme coins. You can [check out](https://github.com/sb-child/ecosystem#meme) what's there.

---

<details><summary>Original content:</summary>

I like making cute and interesting things, though some of them are still not open-sourced or committed to GitHub, which makes the tiles of my contribution graph look shabby...
...
Estrogen drugs DIY guide, _for [Feminizing hormone therapy](https://en.wikipedia.org/wiki/Feminizing_hormone_therapy)_:
...
- ~~Estradiol Gel~~ (there are already too many guides for this on GitHub)

### [sbc-io] SB's lab

(it's just a small lab~ but it's a bit lewd...)
